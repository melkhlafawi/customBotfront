...
#TODO: RUN npm install -C $SCRIPTS_FOLDER p-wait-for mongodb this is correct but we need to check the version of the NPM because it needs import instead of require in the index.js inside the p-wait-for lib
#RUN cd $SCRIPTS_FOLDER
#RUN npm install p-wait-for
